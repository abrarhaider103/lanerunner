                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" method="post" id="recupera_pass" action="authentication/sign-in/reset_pass.php">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <!--end::Title-->
                            <!--begin::Link-->
                            <div class="text-gray-400 fw-semibold fs-4">Enter your email here to reset your password.</div>
                            <!--end::Link-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group-->
                        ...
                        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                            ...
                            <a href="https://app.lanerunner.com/" class="btn btn-lg btn-light-primary fw-bold">Cancel</a>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
