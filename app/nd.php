...
/*
echo "<pre>";
var_dump($_SESSION['customer']->customer_dismiss_modal);
exit;
*/
?>
<!DOCTYPE html>
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('assets/media/svg/shapes/top-green.png" data-theme="light">
                                                ...
                                                <h3 class="card-title align-items-start flex-column text-white pt-15">
                                                    <span class="fw-bold fs-2x mb-3">Hello, <?php echo $_SESSION['customer']->customer_name; ?></span>
                                    ...
                                    <div class="col-xl-4 mb-xl-10">
                                        ...
                                        <div class="card card-flush h-lg-100">
                                            ...
                                            <div class="card-header pt-7 mb-5">
                                                <!--begin::Title-->
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-800">HOT LANES</span>
                                    ...
                                    <div class="col-xl-4 mb-xl-10">
                                        ...
                                        <div class="card card-flush h-lg-100">
                                            ...
                                            <div class="card-header pt-7 mb-5">
                                                <!--begin::Title-->
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-800">COLD LANES</span>
                                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">20 countries share 97% visits</span>
                                                </h3>
                                                <!--end::Title-->
                                                <!--begin::Toolbar-->
                                    ...
                                    <div class="col-xl-4 mb-xl-10">
                                        ...
                                        <div class="card card-flush h-lg-100">
                                            ...
                                            <div class="card-header pt-5">
                                                <!--begin::Title-->
                                                <h3 class="card-title text-gray-800">Price change alerts</h3>
                                                <!--end::Title-->
                                                <!--begin::Toolbar-->
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card h-md-100">
                                            ...
                                            <div class="card-body d-flex flex-column flex-center">
                                                ...
                                                <div class="mb-2">
                                                    <!--begin::Title-->
                                                    <h1 class="fw-semibold text-gray-800 text-center lh-lg">News & features
                                                        <br />new
                                                ...
                                                <div class="text-center mb-1">
                                                    <!--begin::Link-->
                                                    <a class="btn btn-sm btn-primary me-2" href="subscribe.php">Try Now</a>
                                                    <!--end::Link-->
                                                    <!--begin::Link-->
                                                    <a class="btn btn-sm btn-light" href="features.php">Learn More</a>
                                                    <!--end::Link-->
                                                </div>
                                                <!--end::Links-->
                                            </div>
