        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="login_mobile.php">
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="text" id="customer_email" name="customer_email"
                                   autocomplete="off" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Link-->
                                <a href="authentication/sign-in/password-reset.php"
                                   class="link-primary fs-6 fw-bold">Reset Password</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Input wrapper-->
                        ...
                        <div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
                            ...
                            <div class="d-flex fw-semibold fs-6">
                                <p class="text-black">By continuing you agree to our
                                    ...
                                    <a href="#" class="text-hover-primary px-1" data-bs-toggle="modal" data-bs-target="#kt_modal_terms">Terms and Conditions</a>
                                </p>
                            </div>
                            <!--end::Links-->
                        </div>
...
<script>
    ...
    Swal.fire({
        ...
        customClass: { confirmButton: "btn btn-primary btn-active" },
    });
    <?php
    }
    ?>
